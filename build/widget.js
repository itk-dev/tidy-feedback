...
/* harmony import */ var _component_region__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./component/region */ "./assets/component/region.js");
/* harmony import */ var _zumer_snapdom__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @zumer/snapdom */ "./node_modules/@zumer/snapdom/dist/snapdom.mjs");
/* harmony import */ var _cypress_unique_selector__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @cypress/unique-selector */ "./node_modules/@cypress/unique-selector/lib/index.js");
...
var widget = root !== null && root !== void 0 ? root : document;
...
var getDocumentElement = function getDocumentElement(selector) {
  return document.querySelector(selector);
};
var config = function () {
  var el = getElement("[data-tidy-feedback-config]");
  if (el) {
    try {
...
var selectRegion = function selectRegion() {
  if (region) {
    region.hidden = false;
    (0,_component_region__WEBPACK_IMPORTED_MODULE_14__.makeResizableDiv)(region);
...
var hideRegion = function hideRegion() {
  if (region) {
    region.hidden = true;
  }
};
...
var hideForm = function hideForm(reset) {
  hideRegion();
  if (form) {
    form.hidden = true;
    if (reset) {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              ...
              el = document.body;
              _context2.n = 2;
              return (0,_zumer_snapdom__WEBPACK_IMPORTED_MODULE_15__.snapdom)(el, {
                scale: 1
              });
            case 2:
              result = _context2.v;
            ...
            case 4:
              ...
              formData = new FormData(form); // https://stackoverflow.com/a/46774073
              ...
              data.context = {
                ...
                first_element: firstElement === null || firstElement === void 0 ? void 0 : firstElement.outerHTML,
                first_element_selector: firstElement ? (0,_cypress_unique_selector__WEBPACK_IMPORTED_MODULE_16__["default"])(firstElement) : null,
                last_element: firstElement === null || firstElement === void 0 ? void 0 : firstElement.outerHTML,
                last_element_selector: firstElement ? (0,_cypress_unique_selector__WEBPACK_IMPORTED_MODULE_16__["default"])(firstElement) : null,
                navigator: {
